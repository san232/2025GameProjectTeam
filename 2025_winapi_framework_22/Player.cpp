...
void Player::RenderExpUI(HDC _hdc)
{
	...
	if (filledWidth > 0)
	{
		GET_SINGLE(SpriteRenderer)->DrawFilledRect((float)innerLeft, (float)innerTop, (float)(filledRight - innerLeft), (float)(innerBottom - innerTop), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f));
	}
