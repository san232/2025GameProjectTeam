	...
	, m_dashDuration(0.8f)
{
	...
	m_animator->CreateAnimation(L"Charge", m_pTex, { 0.f, 192.f }, { 64.f, 64.f }, { 64.f,0.f }, 4, 0.05f); 
	m_animator->CreateAnimation(L"Dash", m_pTex, { 0.f, 0.f }, { 64.f, 64.f }, { 64.f,0.f }, 7, 0.05f);
