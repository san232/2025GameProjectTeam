    ...
    , m_target(nullptr)
{
    ...
    SetMoveSpeed(250.f);
    SetAttackPower(1);
    m_pTex = GET_SINGLE(ResourceManager)->GetTexture(L"ConchBullet");
}
...
void ConchBullet::Render(HDC _hdc)
{
    Vec2 pos = GetPos();
    Vec2 size = GetSize();
...
void ConchBullet::EnterCollision(Collider* _other)
{
...
void ConchBullet::StayCollision(Collider* _other)
{
}

void ConchBullet::ExitCollision(Collider* _other)
{
}

void ConchBullet::Move()
{
    Vec2 pos = GetPos();
